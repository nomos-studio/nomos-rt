...
/* Hand-written for kairos vendored liburcu — macOS x86_64 / aarch64. */
...
/* clock_gettime() available since macOS 10.12 (Sierra). */
#define CONFIG_RCU_HAVE_CLOCK_GETTIME 1

/* sys_membarrier does not exist on macOS — urcu-bp only on this platform. */
...
/* Multi-flavor support (urcu-bp usable in same binary; urcu-mb not available). */
