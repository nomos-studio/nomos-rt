...
lets_splosh_modulator::lets_splosh_modulator(const modulator_engine* engine, std::string c_src,
...
float lets_splosh_modulator::read_cv_src(const std::string& src, float fallback) const noexcept {
